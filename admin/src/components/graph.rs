...
impl Graph {
    fn render_gl(&mut self, timestamp: f64, ctx: &Context<Self>) {
        ...
        let bg_vert_code = include_str!("./shaders/solid.vert");
        let bg_frag_code = include_str!("./shaders/solid.frag");
        ...
        let point_vert_code = include_str!("./shaders/point.vert");
        let point_frag_code = include_str!("./shaders/point.frag");
        ...
        gl.draw_arrays(GL::TRIANGLES, 0, vertices.len() as i32 / 4);
        ...
        let selected_vert_code = include_str!("./shaders/selected.vert");
        let selected_frag_code = include_str!("./shaders/selected.frag");
