...
function getImports() {
    ...
    imports.wbg.__wbindgen_closure_wrapper16741 = function(arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 1354, __wbg_adapter_37);
        return addHeapObject(ret);
    };
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('lightning-9bd45cb999ebf6b9_bg.wasm', import.meta.url);
    }
    const imports = getImports();
